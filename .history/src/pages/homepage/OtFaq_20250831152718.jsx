    ...
    <>
      <section className="section-container faq">
        ...
        <section className="faq-container">
          <details>
            ...
            <section>
              <p>
                ...
                in Australia. The plan outlines the individual’s goals, needs,
                and the types of support and services they are eligible to
                receive under the NDIS. Here are the key components of an NDIS
                plan:
              </p>
              <ul>
                <li>
                  Personal Goals: The plan includes the participant's goals and
                  aspirations, such as improving daily living skills, gaining
                  employment, or increasing community participation.
                </li>
                <li>
                  Support Categories: It details the types of support and
                  services required to achieve these goals. This can include
                  personal care, therapy services, assistive technology, or home
                  modifications.
                </li>
                <li>
                  Funding Allocation: The plan specifies how much funding is
                  allocated for different categories of support and how this
                  funding can be used. This can be in the form of core supports,
                  capital supports, or capacity building supports.
                </li>
                <li>
          ...
          <details>
            <summary>What are the different types of plan managements?</summary>
            <section className="answers">
              <p>
                <span className="note">Self-Managed</span>: Participants manage
                their NDIS funds themselves. They have full control over their
                budget, can choose any provider, and handle all the
                administrative tasks like paying invoices and keeping records.
              </p>
              <p>
                <span className="note">Plan-Managed</span>: A Plan Manager is
                hired to manage the NDIS funds on behalf of the participant. The
                Plan Manager handles the financial and administrative
                responsibilities, such as paying providers and keeping track of
                spending, while the participant still has flexibility in
                choosing providers.
              </p>
              <p>
                ...
                NDIA takes care of all payments and administration, offering the
                least administrative burden for the participant but with more
                restrictions on provider choice. Please note *
                <span className="note">
          ...
          <details>
            ...
            <section className="answers">
              <ul>
                <li>
                  Bulk-biling consultation is currently unavailable. If you wish
                  to discuss further, please contact our team at
                ...
                <li>
                  If the service is fully bulk-billed, you won't be required to
                  pay anything out-of-pocket. Medicare covers the full fee.
                </li>
              </ul>
            </section>
          </details>
          <details>
            ...
            <section className="answers">
              <p>
                ...
                people with significant and permanent disabilities. It provides
                funding for services and supports that are tailored to an
                individual's needs, enabling them to live as independently as
                possible.
              </p>
              <p>
                The NDIS focuses on long-term assistance, including therapies,
                equipment, and personal care, to help participants achieve their
                goals in areas like education, employment, and social
                participation.
              </p>
              <p>
                ...
                government-funded, NDIS is more specialised in supporting people
                with disabilities, whereas Medicare provides broad health
                coverage for the general population.
              </p>
            </section>
          </details>
          <details>
            ...
            <section className="answers">
              <p>
                ...
                office or local NDIS partner or call 1800 800 110 and ask for an
                ...
                complete the NDIS Access Request Form on your computer and email
                it to
          ...
          <details>
            ...
            <section className="answers">
              <p>
                ...
                may not qualify for government-funded programs like the NDIS or
                Medicare or who prefer to access additional or specific services
                beyond what is covered.
              </p>
              <p>
                Paying privately allows for greater flexibility in choosing the
                therapist, the type of therapy, and the frequency of sessions,
                making it an option for those seeking more personalised or
                immediate care.
              </p>
            </section>
          </details>
