        ...
        <header aria-label="homepage-header">
          <nav aria-label="navigation">
            ...
            <ul className="menu">
              ...
              <li>
                <a href="expertise.html">OT Services</a>
              </li>
              <li>
              ...
              <li>
                <a href="https://choosetherapy.com.au/blog" target="_blank">
                  Blog
                </a>
              </li>
            </ul>
          ...
          <section className="section-container ot-benefits">
            ...
            <section className="benefits-container">
              ...
              <section className="benefits-content">
                ...
                <p>
                  Our OTs visit you in the comfort of your home anywhere in
                  Perth, delivering hands-on, goal-based therapy
                </p>
              </section>
              <section className="benefits-content">
                <h2>Individualised Therapy Sessions</h2>
                <p>
                  We tailor every session to your unique needs, creating a
                  therapy experience that fits your NDIS goals and lifestyle
                </p>
              </section>
              <section className="benefits-content">
              ...
              <section className="landingpage-buttons">
                <a href="expertise.html">Learn more about our services</a>
              </section>
            </section>
          </section>
            ...
            <section className="ot-services-container">
              ...
              <section className="ot-services-content">
                ...
                <p>
                  ...
                  occupational therapy for adults in Perth. We work with
                  physical, neurological, and psychosocial needs—at home or via
                  NDIS
                </p>
              </section>
              <section className="ot-services-content">
                ...
                <p>
                  ...
                  qualified occupational therapists in Perth. Essential for
                  access requests, plan reviews, or therapy recommendations
                </p>
              </section>
              <section className="ot-services-content">
              ...
              <section className="ot-services-content">
                ...
                <p>
                  We design and recommend practical home modifications,
                  including bathroom and shower adaptations, to help you stay
                  safe and independent in your own space—NDIS-supported and
                  expert-approved
                </p>
              </section>
            </section>
            <section className="landingpage-buttons first-button">
              <a href="pricing.html">Learn about our pricing</a>
            </section>
          ...
          <section className="section-container faq">
            ...
            <section className="faq-container">
              <details>
                ...
                <section>
                  <p>
                    ...
                    (NDIS) in Australia. The plan outlines the individual’s
                    goals, needs, and the types of support and services they are
                    eligible to receive under the NDIS. Here are the key
                  ...
                  <ul>
                    ...
                    <li>
                      Service Providers: It may list approved service providers
                      or allow participants to choose their own providers to
                      deliver the necessary supports.
                    </li>
                    <li>
                      Plan Review: The plan is reviewed periodically (usually
                      annually) to assess progress and make adjustments based on
                      changes in needs, goals, or circumstances. This is where
                      you gather all of your provider’s progress reports or
                      updated functional assessment reports
                    </li>
                  </ul>
                  <p>
              ...
              <details>
                ...
                <section className="answers">
                  <p>
                    ...
                    acquiring essential skills to boost your independence,
                    enhance your confidence, and better manage the daily
              ...
              <details>
                ...
                <section className="answers">
                  <p>
                    Currently, Choose Therapy only offers services to
              ...
              <details>
                ...
                <section className="answers">
                  <p>
                    ...
                    over their budget, can choose any provider, and handle all
                    the administrative tasks like paying invoices and keeping
                    records.
                  </p>
                  <p>
                    <span className="note">Plan-Managed</span>: A Plan Manager
                    is hired to manage the NDIS funds on behalf of the
                    participant. The Plan Manager handles the financial and
                    administrative responsibilities, such as paying providers
                    and keeping track of spending, while the participant still
                    has flexibility in choosing providers.
                  </p>
                  <p>
                    <span className="note">NDIA-Managed</span>: The National
                    Disability Insurance Agency (NDIA) manages the funds
                    directly. Participants can only use NDIS-registered
                    providers, and the NDIA takes care of all payments and
                    administration, offering the least administrative burden for
                    the participant but with more restrictions on provider
                    choice. Please note *
                    <span className="note">
                ...
                <section className="answers">
                  <ul>
                    ...
                    <li>
                      ...
                      to pay anything out-of-pocket. Medicare covers the full
                      fee.
                    </li>
                  </ul>
                </section>
              ...
              <details>
                ...
                <section className="answers">
                  ...
                  <p>
                    The NDIS focuses on long-term assistance, including
                    therapies, equipment, and personal care, to help
                    participants achieve their goals in areas like education,
                    employment, and social participation.
                  </p>
                  <p>
                    In contrast, <span className="note">Medicare</span> is
                    Australia's universal health care system that covers basic
                    medical services for all Australians, including doctor
                    visits, hospital care, and essential treatments. Medicare is
                    not specifically designed for disability-related needs but
                    rather offers general health care. While both NDIS and
                    Medicare are government-funded, NDIS is more specialised in
                    supporting people with disabilities, whereas Medicare
                    provides broad health coverage for the general population.
                  </p>
                </section>
              </details>
              <details>
                ...
                <section className="answers">
                  <p>
                    If you are eligible for NDIS, you can contact your local
                    NDIS office or local NDIS partner or call 1800 800 110 and
                    ask for an
                    <a href="https://www.ndis.gov.au/media/2323/download?attachment">
              ...
              <details>
                ...
                <section className="answers">
                  <p>
                    ...
                    services. Private OT services are available to individuals
                    who may not qualify for government-funded programs like the
                    NDIS or Medicare or who prefer to access additional or
                    specific services beyond what is covered.
                  </p>
                  <p>
            ...
            <section className="landingpage-buttons">
              <a href="expertise.html">Contact Us</a>
            </section>
          </section>
          ...
          <section className="footer-main">
            <section className="left-footer">
              ...
              <section className="social-media">
                <a href="https://www.facebook.com/choosetherapy.au">
                  <img
                ...
                <a href="https://www.instagram.com/choosetherapy.au/">
                  <img src="./images/instagram-logo.png" alt="instagram logo" />
                </a>
                <a href="https://au.linkedin.com/in/jerome-choo-42639375?original_referer=https%3A%2F%2Fwww.google.com%2F">
                  <img
                ...
                <a href="https://www.youtube.com/@Choose-Therapy">
                  <img
            ...
            <section className="address">
              <div className="vcard">
                ...
                <a className="email" href="mailto:choosetherapy@gmail.com">
