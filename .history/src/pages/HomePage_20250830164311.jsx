        ...
        <header aria-label="homepage-header">
          <nav aria-label="navigation">
            ...
            <ul className="menu">
              ...
              <li>
                <Link to="expertise.html">OT Services</Link>
              </li>
              <li>
            ...
            <section id="hamburger-menu">
              <nav>
                <ul>
                  ...
                  <li>
                    <Link
                      to="https://choosetherapy.com.au/blog"
                      target="_blank"
                    >
                      Blog
                    </Link>
        ...
        <main id="index">
          ...
          <section className="section-container ot-benefits">
            ...
            <section className="benefits-container">
              ...
              <section className="landingpage-buttons">
                <Link to="expertise.html">Learn more about our services</Link>
              </section>
            </section>
          </section>
          <section className="section-container ot-services">
            ...
            <section className="landingpage-buttons first-button">
              <Link to="pricing.html">Learn about our pricing</Link>
            </section>
            <section className="landingpage-buttons second-button">
              <Link to="contact.html">Inquire now</Link>
            </section>
          </section>
          ...
          <section className="section-container faq">
            ...
            <section className="landingpage-buttons">
              <Link to="expertise.html">Contact Us</Link>
            </section>
          </section>
        ...
        <footer aria-label="homepage-footer">
          ...
          <section className="copyright">
            <nav>
              <ul>
                <li>
                  <Link to="/index.html">Choose Therapy</Link>
                </li>
                <li>
                  <Link to="expertise.html">OT Services</Link>
                </li>
                ...
                <li>
                  <Link to="contact.html">Support</Link>
                </li>
              </ul>
            </nav>
