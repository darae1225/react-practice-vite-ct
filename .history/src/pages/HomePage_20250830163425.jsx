    ...
    <div id="wrapper">
      <header aria-label="homepage-header">
        <nav aria-label="navigation">
          ...
          <ul class="menu">
            ...
            <li><a href="expertise.html">OT Services</a></li>
        ...
        <section id="nav-cont" class="nav-icon-container">
          <a href="/"
            ><img
              src="./images/choose-therapy-logo-transparent.png"
              class="nav-logo-img"
      ...
      <main id="index">
        ...
        <section class="section-container ot-benefits">
          ...
          <section class="benefits-container">
            ...
            <section class="landingpage-buttons">
              <a href="expertise.html">Learn more about our services</a>
            </section>
          </section>
        </section>
        <section class="section-container ot-services">
          <h1>Our services</h1>
          <section class="ot-services-container">
            <section class="ot-services-content">
          ...
          <section class="landingpage-buttons first-button">
            <a href="pricing.html">Learn about our pricing</a>
          </section>
          <section class="landingpage-buttons second-button">
            <a href="contact.html">Inquire now</a>
          </section>
        </section>
        <section class="section-container ot-appointment">
        ...
        <section class="section-container faq">
          ...
          <section class="faq-container">
            ...
            <details>
              ...
              <section class="answers">
                <p>
                  <span class="note">Self-Managed</span>: Participants manage
                ...
                <p>
                  <span class="note">Plan-Managed</span>: A Plan Manager is
                ...
                <p>
                  <span class="note">NDIA-Managed</span>: The National
                  ...
                  more restrictions on provider choice. Please note *<span
                    class="note"
            ...
            <details>
              ...
              <section class="answers">
                <p>
                  The
                  <span class="note"
                    >National Disability Insurance Scheme (NDIS)</span
                  >
                ...
                <p>
                  In contrast, <span class="note">Medicare</span> is Australia's
                  universal health care system that covers basic medical
                  services for all Australians, including doctor visits,
            ...
            <details>
              ...
              <section class="answers">
                <p>
                  ...
                  an
                  <a
                    href="https://www.ndis.gov.au/media/2323/download?attachment"
                    ><span class="links">NDIS Access Request Form</span></a
                  >
                  to be mailed or emailed to you. You can also download and
                  complete the NDIS Access Request Form on your computer and
                  email it to
                  <span class="note">enquiries@ndis.gov.au</span> with
        ...
        <!-- <section class="section-container ot-blogs">
      ...
      <footer aria-label="homepage-footer">
        <section class="footer-main">
          <section class="left-footer">
            ...
            <section class="social-media">
              ...
              /></a>
              <a
                href="https://au.linkedin.com/in/jerome-choo-42639375?original_referer=https%3A%2F%2Fwww.google.com%2F"
                ><img
          ...
          <section class="address">
            <div class="vcard">
              ...
              <div class="tel">0430 522 850</div>
              <a class="email" href="mailto:choosetherapy@gmail.com"
                >choosetherapy@gmail.com</a
              >
              <div class="adr">
                <span class="locality"
              ...
              <div class="org">Occupational Therapy Service</div>
            </div>
          </section>
        </section>
        <section class="copyright">
          <nav>
            <ul>
              <li><a href="/index.html">Choose Therapy</a></li>
              <li><a href="expertise.html">OT Services</a></li>
              <li><a href="#">T&Cs</a></li>
              <li>
                <a
